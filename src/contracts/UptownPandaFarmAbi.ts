...
export default [
    ...
    },
    {
        ...
        name: 'SupplySnapshotUpdated',
        type: 'event',
    },
    {
        inputs: [],
        name: 'HARVEST_CHUNKS_COUNT',
        outputs: [
            {
                internalType: 'uint256',
                name: '',
    ...
    {
        inputs: [],
        name: 'currentIntervalTotalReward',
        outputs: [
            {
                internalType: 'uint256',
                name: '',
